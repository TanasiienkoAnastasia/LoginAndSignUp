...
public class StatisticsOfDates extends javax.swing.JFrame {
    ...
    /**
     * Creates new form StatisticsOfDates
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatisticsOfDates.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatisticsOfDates().setVisible(true);
            }
        });
    }
